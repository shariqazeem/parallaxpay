...
/**
 * X402 Payment Middleware with LOCAL Facilitator
 *
 * This uses the Solana Foundation's Gill template facilitator running locally.
 * The facilitator handles:
 * - Payment verification
 * - Nonce-based replay protection
 * - Transaction sponsorship (pays gas fees)
...
// Local facilitator URL
const facilitatorUrl = process.env.NEXT_PUBLIC_FACILITATOR_URL || 'http://localhost:3002'
...
console.log('[x402 Config] Receiver:', receiverAddress)
console.log('[x402 Config] Network:', network)
console.log('[x402 Config] Facilitator:', facilitatorUrl)
